...
public class MedicalRecordDiagnoseItem implements Serializable {
    ...
    private Integer medical_record_diagnose_id;
    ...
    public Integer getMedical_record_diagnose_id() {
        return medical_record_diagnose_id;
    }

    public void setMedical_record_diagnose_id(Integer medical_record_diagnose_id) {
        this.medical_record_diagnose_id = medical_record_diagnose_id;
    }
    ...
    public String toString() {
        ...
        sb.append(", medical_record_diagnose_id=").append(medical_record_diagnose_id);
