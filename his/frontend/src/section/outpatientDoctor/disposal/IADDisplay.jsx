      ...
      <div>
        ...
        <Collapse accordion bordered={false}>
          {list.map(data=>(
            <Panel header={
              <span>
                <span style={{marginRight:'10px'}}>处置编号：{data.id}</span>
        ...
        >
          ...
          <div>
             <div style={{textAlign:"center"}}>
              <Typography.Title level={3}>{resultData.project.non_drug_item.name}处置报告</Typography.Title>
              <Divider/>
              <span style={{marginRight:'20px'}}>操作员工号：<b>{resultData.user_id}</b></span>
            </div>

            <Typography.Title level={4}>处置结果：</Typography.Title>
