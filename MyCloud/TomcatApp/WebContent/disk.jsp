  ...
  <div class="content-wrapper">
    ...
    <div style="margin:0px 0px 10px 0px">
      <!--工具栏-->
	     <div class="form-inline">
	       <button class="btn"  data-toggle="modal" data-target="#uploadModal"><i class="fas fa-cloud-upload-alt"></i></button>&nbsp;
	       <input class="form-control" type="text" id="newFolderName" placeholder="文件夹名字">
	       <button class="btn primary" onclick="createFolder(document.getElementById('newFolderName').value)">创建</button>
	     </div>
	</div>

      <!-- 目录状态栏-->
      <ol class="breadcrumb" id="pathPanel">当前目录 加载中...</ol>
      <div class="row">
          <div class="col-12">
    ...
    <div class="modal fade" id="uploadModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="uploadModalLabel">上传</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
    ...
    <script src="js/my-disk.js"></script>
  </div>
</body>
</html>
