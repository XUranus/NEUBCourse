...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle mr-lg-2" id="messagesDropdown" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <span class="d-lg-none">消息
              <span class="badge badge-pill badge-primary">12 条新消息</span>
            </span>
          ...
          <div class="dropdown-menu" aria-labelledby="messagesDropdown">
            <h6 class="dropdown-header">消息:</h6>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      <ol class="breadcrumb"><li><span><i class="fa fa-fw fa-file-image"></i>&nbsp;图片</span></li></ol>
      <div class="row">
          <div class="col-12">
   ...
   <div class="modal fade in" id="shareModal" tabindex="-1" role="dialog">
    ...
    <script src="js/catagory-picture.js"></script>
  </div>
</body>
</html>
